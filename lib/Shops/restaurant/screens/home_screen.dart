...
class _HomeScreenState extends State<HomeScreen> {
  Column _buildRestaurants(List restaurant_info_list) {
    final restaurantList = <Widget>[];
    for (final restaurant_info in restaurant_info_list){
      List restaurant = restaurant_info.split(",");
      restaurantList.add(
        GestureDetector(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          _buildRestaurants(snapshot.data!),
                        ],
                      )
                    ],
                  ),
